...
namespace Captcha_Service
{
    public class CaptchaGuru
    {
        ...
        private static readonly string _softGuru = "102564";
        private static readonly string _urlIn = "http://api.captcha.guru/in.php?";
        private static readonly string _urlRes = "http://api.captcha.guru/res.php?";
